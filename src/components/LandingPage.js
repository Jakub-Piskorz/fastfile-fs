          ...
          <div className={style['header__wrapper']}>
            ...
            <article className={style.begin}>
              <p>
                ...
                ipsa quas placeat amet. Sequi dolore hic doloremque blanditiis
                atque repudiandae laudantium non a deleniti quam excepturi
                magni, voluptatem rem quod earum repellendus pariatur.
              </p>
            </article>
          </div>
          {/* <!-- ? Login ? --> */}
          <article className={style.login}>
            ...
            <form action="#" method="post">
              <input
                type="text"
                name="login"
                id={style['login__login']}
                placeholder="Username"
              />
              <input
                type="password"
                name="password"
                id={style['login__password']}
        ...
        <div className={style['footer__wrapper']}>
          <article className={style['about_us']}>
            ...
            <p>
              ...
              tenetur dicta, cupiditate illum, vero reprehenderit eius corrupti
              id quos voluptate, voluptas incidunt numquam ut.
            </p>
          </article>
